    ...
    <div className="bg-amber-900 min-h-screen">
      ...
      >
        <input
          ...
          className="py-2 text-amber-50 w-1/2 px-4 border border-amber-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
        />
        <button
          type="submit"
